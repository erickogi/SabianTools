...
public class SabianMaterialModal extends SabianViewModal {
    ...
    private SabianFitImage sfi_HeaderIcon,sfi_HeaderIconClose,sfi_HeaderIconBack;
    ...
    private void init_elements(){
        ...
        sfi_HeaderIconBack=(SabianFitImage) findViewById(R.id.sfi_SabianMaterialModalIconBack);
    ...
    public SabianMaterialModal setNoContentPadding(boolean noContentPadding) {
    ...
    public SabianMaterialModal setOnButtonBackClickListener(View.OnClickListener onButtonBackClickListener) {
    ...
    public SabianMaterialModal setBackButtonVisibility(int visibility){
